    ...
    return (
        <div className="bg-white/60 dark:bg-white/5 backdrop-blur-md border border-slate-200/50 dark:border-white/10 p-5 rounded-3xl transition-all hover:bg-white hover:shadow-lg dark:hover:bg-white/10 hover:scale-[1.01]">
            <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-2xl bg-white/80 dark:bg-white/10 overflow-hidden flex items-center justify-center shrink-0 border border-slate-200/50 dark:border-white/10 relative">
                    {post.userImage ? (
                        <NextImage
                            src={post.userImage}
                            alt={post.user || "User avatar"}
                            width={40}
                            height={40}
                            className="w-full h-full object-cover"
                        />
                    ) : (
                        <UserCircleIcon className="w-6 h-6 text-slate-500 dark:text-white/50" />
                    )}
                </div>
